...
function shapeblock_create_block_table_block_init() {
	...
	wp_register_style(
		'shapeblock-table-editor-style',
		plugins_url( 'build/index.css', __FILE__ ),
		array( 'shapeblock-table-style' ),
		shapeblock_asset_version( __DIR__ . '/build/index.css' )
	);

	register_block_type( __DIR__ . '/build', array(
		'style'        => 'shapeblock-table-style',
		'editor_style' => 'shapeblock-table-editor-style',
	) );
}
add_action( 'init', 'shapeblock_create_block_table_block_init' );
